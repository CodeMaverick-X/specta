...
export default function Auth({ session }: { session: Session | null; }) {
    ...
    const logout = <form action={Logout}> <button type="submit" className="inline pr-3 mt-10 bg-[#78242e] h-10 w-24 p-1 mr-5 rounded-sm border-[#d73c3c] border hover:bg-[#e04848] hover:text-black"
